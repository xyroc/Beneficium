...
public class Beneficium {
	...
	public static boolean XP_BOOST_ENABLE_LEVEL_TRESHOLD;
	public static int XP_BOOST_ENABLE_LEVEL_TRESHOLD_VALUE;
	...
	public void init(FMLInitializationEvent event) {
		...
		XP_BOOST_ENABLE_LEVEL_TRESHOLD = config.getBoolean("XP_BOOST_ENABLE_LEVEL_TRESHOLD", "xp_multipliers", false, "If set to true, the talismans will be inactive when the players level is below XP_BOOST_ENABLE_LEVEL_TRESHOLD_VALUE");
		XP_BOOST_ENABLE_LEVEL_TRESHOLD_VALUE = config.getInt("XP_BOOST_ENABLE_LEVEL_TRESHOLD_VALUE", "xp_multipliers", 10, 1, 128, "The xp treshold value for the talismans");
